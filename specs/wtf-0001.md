...
`Interface ID` is a 'hashed' `Interface name` with simple CRC32.
...
Introspection interface is named `org.ton.introspection.v0` and it's ID id `1403833071`. 

In order to implement it contract should implement `supported_interfaces` function.

NOTE: `1403833071` ALWAYS have to be the first value in this list.
